...
/*Err*/			    {14,14,14,14,14,14,14,14,14,14,14,14,14}
	...
	switch(estado){
		...
		case 5: printf("Suma");
		case 6: printf("Resta");
		case 7: printf("ParenIzq /n");
		case 8: printf("ParenDer /n");
		case 9: printf("Coma /n");
		case 10: printf("PuntoYComa /n");
		case 12: printf("Asignacion /n");
		case 13: printf("Fin de Texto/n");
		case 14: printf("Error Lexico /n");
	}
	return 0;
}
